...
namespace Services.Implementations
{
    public class SaleReturnService : ISaleReturnService
    {
        ...
        public async Task<SaleReturnConfirmResult> ProcessReturnConfirmAsync(SaleReturnConfirm returnConfirmDto)
        {
            try
            {
            ...
            {
                return new SaleReturnConfirmResult { IsSuccess = false, Message = $"Помилка: {ex.Message}", InvoiceNo = "" };
            }
        }
    }
}
